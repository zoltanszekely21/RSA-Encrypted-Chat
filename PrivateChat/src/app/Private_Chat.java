...
public class Private_Chat extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        Private_Chat app = new Private_Chat("Aplicatie Chat Privat");
        if (url != null) {
        ...
        app.jTextField2.setVisible(false);
        app.jTextArea1.append("    Aplicatie chat privat folosind algoritmul de incriptare RSA 2048 - Szekely Zoltan-IAG An 2\n");
        ...
        while (app.isEnabled()) {
            if (app.isSet) {
                ...
                if (app.server) {
                    ...
                    app.jTextArea1.append("Serverul a pornit\n");
                    while (true) {
                        if (app.isSet) {
                    ...
                    clientStation.start();
                    app.jTextArea1.append("Clientul a pornit\n");
                    while (true) {
                        if (app.isSet) {
